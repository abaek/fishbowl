...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseComponent = __webpack_require__(58);
	...
	ReactDOM.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(_BaseComponent2.default, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapActionCreators = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Landing = __webpack_require__(59);

	var _Landing2 = _interopRequireDefault(_Landing);

	var _Lobby = __webpack_require__(60);

	var _Lobby2 = _interopRequireDefault(_Lobby);

	var _Word = __webpack_require__(61);

	var _Word2 = _interopRequireDefault(_Word);

	var _Teams = __webpack_require__(62);

	var _Teams2 = _interopRequireDefault(_Teams);

	var _Scores = __webpack_require__(63);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(BaseComponent);
	...
	var Landing = function (_React$Component) {
	  ...
	  _createClass(Landing, [{
	    ...
	    value: function render() {
	      ...
	      var numWords = _props.numWords;
	      var startGame = _props.startGame;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    numTeams: function numTeams(num) {
	      return dispatch({
	...
	var Teams = function (_React$Component) {
	  ...
	  _createClass(Teams, [{
	    ...
	    value: function handleNameChange(i, event) {
	      var tNames = this.state.teamNames;
	    ...
	    key: 'handleNumTeamChange',
	    value: function handleNumTeamChange(num, event) {
	      this.setState({
	        numTeams: num
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      var _state = this.state;
	      var teamNames = _state.teamNames;
	      var numTeams = _state.numTeams;
	      ...
	      for (var i = 2; i < 4; i++) {
	        ...
	        teamCount.push(React.createElement(
	          'button',
	          {
	            className: className,
	      ...
	      var _loop = function _loop(_i) {
	        names.push(React.createElement(
	          ...
	          React.createElement('input', {
	            ...
	            ref: 'input' + _i,
	            value: teamNames[_i],
	            onChange: _this2.handleNameChange.bind(_this2, _i),
	            onFocus: function onFocus() {
	              _this2.refs['input' + _i].select();
	            } }),
	          React.createElement('br', null)
	        ));
	      };

	      for (var _i = 0; _i < numTeams; _i++) {
	        _loop(_i);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Scores = function (_React$Component) {
	  ...
	  function Scores() {
	    ...
	    return _possibleConstructorReturn(this, (Scores.__proto__ || Object.getPrototypeOf(Scores)).apply(this, arguments));
	  }
